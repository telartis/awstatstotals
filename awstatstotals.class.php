...
class awstatstotals
{
     ...
     * @return string
     */
    public function byte_format($number, $decimals = 2)
    {
     ...
     * @return string
     */
    public function num_format($number, $decimals = 0)
    {
...
<br><br><center><b>AWStats Totals 1.20</b> - <a
href="https://www.telartis.nl/en/awstats">&copy; 2004-2023 Telartis BV</a></center><br><br>
     ...
     * @return string
     */
    public function fetch_form($script_url, $month, $year, $message)
    {
...
';
     ...
     * @return string
     */
    public function fetch_table_header($url, $message)
    {
        $html = '';
        if ($this->NotViewed == 'columns') {
            $html .= '<tr>';
